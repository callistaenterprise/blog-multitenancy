...
@Slf4j
public class TenantAwareRoutingConnectionFactory extends AbstractRoutingConnectionFactory {
    ...
    public TenantAwareRoutingConnectionFactory(ConnectionFactoryLookup connectionFactoryLookup) {
